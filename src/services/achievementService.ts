...
const SEED_TITLES: SyndicateTitle[] = [
  {
    ...
    tag: '[SHADOW OPERATIVE]',
    lore: 'Earned by operatives who complete covert infiltrations into fortified syndicate vaults without alerting high command.',
    rarity: 'STANDARD',
    glowColor: '#10b981',
    gradient: 'linear-gradient(90deg, #10b981, #34d399)',
    unlocked: true,
    equipped: false,
    sourceAchievementId: 'heist_first_blood',
    bonusPerk: '+5% Heist Recon Accuracy',
  },
  {
    id: 'title_kingpin',
    name: 'Vault Kingpin',
    tag: '[VAULT KINGPIN]',
    lore: 'Bestowed upon collectors whose private vaults possess state-of-the-art ballistic defenses and repelled incursions.',
    rarity: 'COVERT',
    glowColor: '#06b6d4',
    gradient: 'linear-gradient(90deg, #06b6d4, #3b82f6)',
    unlocked: true,
    equipped: false,
    sourceAchievementId: 'vault_aegis_citadel',
    bonusPerk: '+5% Passive Vault Breach Resistance',
  },
  {
    id: 'title_broker',
    name: 'Black Market Broker',
    tag: '[BLACK MARKET BROKER]',
    lore: 'Awarded to master negotiators who settle multi-million dollar high-stakes P2P artwork swaps via atomic escrow.',
    rarity: 'STANDARD',
    glowColor: '#f59e0b',
  ...
  },
  {
    ...
    tag: "[LLOYD'S UNDERWRITER]",
    lore: 'Accredited syndicate underwriter with direct ties to the Lloyd\'s of Torn art syndicate risk consortium.',
    rarity: 'MYTHIC',
    glowColor: '#10b981',
    gradient: 'linear-gradient(90deg, #10b981, #fbbf24)',
    unlocked: true,
    equipped: false,
    sourceAchievementId: 'insurance_lloyds_sovereign',
    bonusPerk: '15% Off Weekly Lloyd\'s Insurance Premiums',
  },
  {
    id: 'title_archon',
    name: 'Archon of Torn City',
    tag: '[ARCHON OF TORN]',
    lore: 'The absolute pinnacle of underworld prestige. Sovereign patron of illicit fine arts and kingpin of the syndicate market.',
    rarity: 'ARCHON',
    glowColor: '#e61919',
    gradient: 'linear-gradient(90deg, #e61919, #fbbf24, #f43f5e)',
    unlocked: true,
    equipped: true, // Default equipped for high-roller immersive demo
...
const SEED_FRAMES: AvatarFrame[] = [
  ...
  {
    id: 'frame_titanium_blast',
    name: 'Titanium Reinforced Plate',
    description: 'Industrial cold-rolled ballistic steel plate with reinforced hex-riveted corners.',
    rarity: 'CLASSIFIED',
    glowColor: '#3b82f6',
    cssClass: 'frame-titanium-blast',
    unlocked: true,
    equipped: false,
    sourceAchievementId: 'vault_repelled',
  },
  {
  ...
  },
  {
    ...
    unlocked: true,
    equipped: true, // Default equipped for high-roller demo
    sourceAchievementId: 'archon_supreme',
  },
];
...
const SEED_ACHIEVEMENTS: Achievement[] = [
  // ── Heist Operative
  {
    id: 'heist_first_blood',
    title: 'Shadow Operative',
    description: 'Successfully plan and execute your first syndicate vault breach infiltration.',
    category: 'HEIST_OPERATIVE',
    rarity: 'STANDARD',
    icon: 'Crosshair',
    progress: 1,
    maxProgress: 1,
    unlocked: true,
    unlockedAt: new Date(Date.now() - 6 * 86400_000).toISOString(),
    claimed: true,
    reward: { type: 'TITLE', value: 'title_shadow', label: 'Title: [SHADOW OPERATIVE]' },
    trackTag: '[CRIME 2.0]',
  },
  {
    id: 'heist_citadel_crack',
    title: 'Monarch Breacher',
    description: 'Crack through the 5-star defense grid of Monarch Primary Citadel and escape clean.',
    category: 'HEIST_OPERATIVE',
    rarity: 'CLASSIFIED',
    icon: 'Sword',
    progress: 0,
    ...
    unlocked: false,
    claimed: false,
    reward: { type: 'EXP', value: 750, label: '+750 Syndicate EXP' },
    trackTag: '[TARGET RECON]',
  },
  {
    id: 'heist_ghost_protocol',
    title: 'Ghost Protocol',
    description: 'Execute 3 successful high-profile heists without losing a single crew specialist.',
    category: 'HEIST_OPERATIVE',
    rarity: 'MYTHIC',
    icon: 'Ghost',
    progress: 1,
    ...
    unlocked: false,
    claimed: false,
    reward: { type: 'EXP', value: 1200, label: '+1,200 EXP & Covert Roster Slot' },
    trackTag: '[CREW OPS]',
  },

  // ── Vault Fortress
  {
    id: 'vault_fortified_bastion',
    title: 'Fortified Bastion',
    description: 'Install 2 or more military-grade defense counter-measures in your private art vault.',
    category: 'VAULT_FORTRESS',
    rarity: 'STANDARD',
    icon: 'ShieldPlus',
    progress: 3,
    maxProgress: 2,
    ...
    claimed: true,
    reward: { type: 'EXP', value: 400, label: '+400 Syndicate EXP' },
    trackTag: '[SECURITY]',
  },
  {
    id: 'vault_aegis_citadel',
    title: 'Aegis Citadel',
    description: 'Reinforce private vault integrity to 85%+ overall breach resistance.',
    category: 'VAULT_FORTRESS',
    rarity: 'COVERT',
    icon: 'ShieldCheck',
    progress: 93,
    ...
    reward: { type: 'TITLE', value: 'title_kingpin', label: 'Title: [VAULT KINGPIN]' },
    trackTag: '[DEFENSE]',
  },
  {
    id: 'vault_repelled',
    title: 'Castle Doctrine',
    description: 'Successfully repel a rival syndicate intrusion attempt using automated counter-measures.',
    category: 'VAULT_FORTRESS',
    rarity: 'CLASSIFIED',
    icon: 'LockKey',
    progress: 1,
    ...
    claimed: true,
    reward: { type: 'AVATAR_FRAME', value: 'frame_titanium_blast', label: 'Frame: Titanium Blast Plate' },
    trackTag: '[LEDGER]',
  },
  {
    id: 'insurance_lloyds_sovereign',
    title: "Lloyd's Sovereign",
    description: "Underwrite your collection under an active Lloyd's of Torn VIP Archon policy.",
    category: 'VAULT_FORTRESS',
    rarity: 'MYTHIC',
    icon: 'Crown',
    progress: 1,
    maxProgress: 1,
    unlocked: true,
    unlockedAt: new Date(Date.now() - 3 * 86400_000).toISOString(),
    claimed: false, // Ready to claim!
    reward: { type: 'TITLE', value: 'title_lloyds', label: "Title: [LLOYD'S UNDERWRITER]" },
    trackTag: '[INSURANCE]',
  },
  ...
  },
  {
    ...
    description: 'Synchronize operations across both the Syndicate Heist Terminal and Black Market Escrow.',
    category: 'HEIST_OPERATIVE',
    rarity: 'CLASSIFIED',
    icon: 'EyeSlash',
    progress: 1,
